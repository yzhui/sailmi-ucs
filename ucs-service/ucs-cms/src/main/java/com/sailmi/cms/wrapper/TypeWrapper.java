 ...
 * @since 2020-12-16
 */
public class TypeWrapper extends BaseEntityWrapper<Type, TypeVO>  {

    public static TypeWrapper build() {
        return new TypeWrapper();
    }

	@Override
	public TypeVO entityVO(Type type) {
		TypeVO typeVO = BeanUtil.copy(type, TypeVO.class);
