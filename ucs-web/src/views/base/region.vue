        ...
        regionOption: {
          ...
          column: [
            ...
            },
            {
              ...
              prop: "level",
              type: "radio",
              dicUrl: apiUrl + "/sailmi-system/dict/dictionary?code=region",
              props: {
                label: "dictValue",
                value: "dictKey"
              },
          ...
          column: [
            {
              ...
              dicUrl:  apiUrl + '/sailmi-system/region/select',
              span: 24,
            },
            {
              label: '地市',
              ...
              dicFlag: false,
              dicUrl:  apiUrl + '/sailmi-system/region/select?code={{key}}',
              span: 24,
            },
            {
              label: '区县',
    ...
    watch: {
      ...
      'excelForm.isCovered'() {
        if (this.excelForm.isCovered !== '') {
          ...
          column.action = `/api/sailmi-system/region/import-region?isCovered=${this.excelForm.isCovered}`;
        }
      }
    },
    computed: {
