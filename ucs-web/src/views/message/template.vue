...
<script>
  import {getList, getDetail, add, update, remove} from "@/api/message/template";
      ...
      return {
        ...
        option: {
          ...
          column: [
            ...
            {
              label: "短信验证码有效时间（秒）",
              prop: "validateCodeExpire",
              rules: [{
                required: true,
                message: "请输入短信验证码有效时间（秒）",
                trigger: "blur"
              }]
            },
            {
