          ...
          column: [
            {
              ...
              action: "/api/sailmi-user/import-user"
            },
            {
              label: '模板下载',
              prop: 'excelTemplate',
    ...
    methods: {
      ...
      handleExport() {
        this.$confirm("是否导出用户数据?", "提示", {
          ...
          window.open(`/api/sailmi-user/export-user?sailmi-auth=${getToken()}&account=${searchForm.account}&realName=${searchForm.realName}`);
        });
      },
      handleTemplate() {
        window.open(`/api/sailmi-user/export-template?sailmi-auth=${getToken()}`);
      },
