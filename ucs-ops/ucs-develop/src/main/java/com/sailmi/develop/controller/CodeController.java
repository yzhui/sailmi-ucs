 ...
 */
package com.sailmi.develop.controller;
...
import com.sailmi.develop.entity.Code;
import com.sailmi.develop.entity.Datasource;
import com.sailmi.develop.service.ICodeService;
import com.sailmi.develop.service.IDatasourceService;
...
public class CodeController extends AppController {
	...
	public R genCode(@ApiParam(value = "主键集合", required = true) @RequestParam String ids, @RequestParam(defaultValue = "sword") String system) {
		...
		System.out.println("Now start generate coding....."+ids);
		codes.forEach(code -> {
		...
		System.out.println("End generate coding....."+ids);
